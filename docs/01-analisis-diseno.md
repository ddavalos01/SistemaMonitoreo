...
|--------|--------------------------------------------------------------------------|-------------------------------------------------|-----------------|---------------|
| Tanque | -Identidicador <br/> -Capacidad maxima <br/> -Estado <br/> -Nivel actual | -String <br/> -Float <br/> -Entero <br/> -Float | getID() <br/> getLevel() <br/> getState() <br/> changeState() <br/> getCapacidadMax() <br/> getNivelPorcentaje() <br/> getResumen() | -Mostrar identificador <br/> -Mostrar nivel actual <br/> -Mostrar estado actual <br/> -Cambiar estado actual <br/> -Mostrar capacidad maxima <br/> -Mostrar porcentaje de llenado <br/> -Mostrar resumen del tanque |
| Sensor | -Identificador <br/> -Lectura de nivel                                   | -String <br/> -FLoat                            | getID() <br/> getLectura() | -Mostrar identificador <br/> -Mostrar lectura actual |
